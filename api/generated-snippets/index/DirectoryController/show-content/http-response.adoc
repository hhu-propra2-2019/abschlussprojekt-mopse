...
<div class="main-wrapper"><main>
    ...
    <form action="/create" method="post"><input type="hidden" name="_csrf" value="26d61d75-587a-4091-95c1-4124963639c9"/>
        <input type="text" name="folderName">
        <input type="submit" name="newFolder" value="Neuer Ordner">
    </form>
    <form action="/upload" method="post"><input type="hidden" name="_csrf" value="26d61d75-587a-4091-95c1-4124963639c9"/>
        <input type="file" name="file">
        <input type="submit" name="uploadFile" value="Datei Hochladen">
    </form>
    <form action="/search" method="post"><input type="hidden" name="_csrf" value="26d61d75-587a-4091-95c1-4124963639c9"/>
        <div id="fileNames">
            <div id="fileNames[0]">
