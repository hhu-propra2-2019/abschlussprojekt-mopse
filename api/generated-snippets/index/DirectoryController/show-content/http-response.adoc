...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="/material1/dir/0/search"
              method="post"><input type="hidden" name="_csrf" value="f819722f-a2b7-40fd-aeb6-8a361949a1f3"/>
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="/material1/dir/0/create" method="post"><input type="hidden" name="_csrf" value="f819722f-a2b7-40fd-aeb6-8a361949a1f3"/>
        ...
        <form class="input-group" action="/material1/dir/0/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="f819722f-a2b7-40fd-aeb6-8a361949a1f3"/>
