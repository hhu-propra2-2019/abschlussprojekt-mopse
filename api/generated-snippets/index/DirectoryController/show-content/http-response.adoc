...
<div class="main-wrapper"><main>
    ...
    <form action="/create" method="post"><input type="hidden" name="_csrf" value="b36f494f-8af5-4307-baa4-b699723000fe"/>
        <input type="text" name="folderName">
        <input type="submit" name="newFolder" value="Neuer Ordner">
    </form>
    <form action="/upload" method="post"><input type="hidden" name="_csrf" value="b36f494f-8af5-4307-baa4-b699723000fe"/>
        <input type="file" name="file">
        <input type="submit" name="uploadFile" value="Datei Hochladen">
    </form>
    <form action="/search" method="post"><input type="hidden" name="_csrf" value="b36f494f-8af5-4307-baa4-b699723000fe"/>
        <div id="fileNames">
            <div id="fileNames[0]">
