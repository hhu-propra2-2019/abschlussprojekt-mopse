...
<div class="main-wrapper"><main>
    ...
    <form action="/create" method="post"><input type="hidden" name="_csrf" value="02c05458-f196-45bb-8d81-f50cd0bee674"/>
        <input type="text" name="folderName">
        <input type="submit" name="newFolder" value="Neuer Ordner">
    </form>
    <form action="/upload" method="post"><input type="hidden" name="_csrf" value="02c05458-f196-45bb-8d81-f50cd0bee674"/>
        <input type="file" name="file">
        <input type="submit" name="uploadFile" value="Datei Hochladen">
    </form>
    <form action="/search" method="post"><input type="hidden" name="_csrf" value="02c05458-f196-45bb-8d81-f50cd0bee674"/>
        <div id="fileNames">
            <div id="fileNames[0]">
