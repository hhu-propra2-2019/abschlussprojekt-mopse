...
<div class="main-wrapper"><main>
    ...
    <div>
        <form action="0/create" method="post"><input type="hidden" name="_csrf" value="ebb66cc8-cc37-4c6c-b792-7e2d2eda3583"/>
            <input type="text" name="folderName" required>
            <input type="submit" name="newFolder" value="Neuer Ordner">
        </form>

        <form action="0/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="ebb66cc8-cc37-4c6c-b792-7e2d2eda3583"/>
            <input type="file" name="file" required>
            <input type="submit" name="uploadFile" value="Datei Hochladen">
        </form>
    </div>

    <form action="0/search" method="post"><input type="hidden" name="_csrf" value="ebb66cc8-cc37-4c6c-b792-7e2d2eda3583"/>
        <div id="names">
            <div id="names[0]">
