...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="0/search"
              method="post"><input type="hidden" name="_csrf" value="333d98e1-652d-426e-8fe9-550c858f5928"/>
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="0/create" method="post"><input type="hidden" name="_csrf" value="333d98e1-652d-426e-8fe9-550c858f5928"/>
        ...
        <form class="input-group" action="0/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="333d98e1-652d-426e-8fe9-550c858f5928"/>
