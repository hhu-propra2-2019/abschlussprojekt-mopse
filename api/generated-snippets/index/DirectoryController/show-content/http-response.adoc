...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="0/search"
              method="post"><input type="hidden" name="_csrf" value="461db90c-c542-4f81-b4b8-5ea7a90e84c3"/>
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="0/create" method="post"><input type="hidden" name="_csrf" value="461db90c-c542-4f81-b4b8-5ea7a90e84c3"/>
        ...
        <form class="input-group" action="0/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="461db90c-c542-4f81-b4b8-5ea7a90e84c3"/>
