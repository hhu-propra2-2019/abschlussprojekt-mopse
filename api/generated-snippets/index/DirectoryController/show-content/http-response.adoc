...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="0/search"
              method="post"><input type="hidden" name="_csrf" value="d2e25f08-17b3-4e17-88eb-95c3b369db6a"/>
    ...
    <div>
        <div class="button-above-wrapper">
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="0/create" method="post"><input type="hidden" name="_csrf" value="d2e25f08-17b3-4e17-88eb-95c3b369db6a"/>
        ...
        <form class="input-group" action="0/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="d2e25f08-17b3-4e17-88eb-95c3b369db6a"/>
