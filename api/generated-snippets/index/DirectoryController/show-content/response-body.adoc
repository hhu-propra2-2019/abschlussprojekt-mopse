...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="/material1/dir/1/search"
              method="post"><input type="hidden" name="_csrf" value="4bb1a7f1-47d4-4b48-8138-8e259d990c53"/>
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="/material1/dir/1/create" method="post"><input type="hidden" name="_csrf" value="4bb1a7f1-47d4-4b48-8138-8e259d990c53"/>
        ...
        <form class="input-group" action="/material1/dir/1/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="4bb1a7f1-47d4-4b48-8138-8e259d990c53"/>
