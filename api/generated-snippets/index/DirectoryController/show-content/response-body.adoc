...
<div class="main-wrapper"><main>
    ...
    <form action="0/create" method="post"><input type="hidden" name="_csrf" value="ea27d555-9d05-49ce-a217-f9dab3358c89"/>
        <input type="text" name="folderName" required>
        <input type="submit" name="newFolder" value="Neuer Ordner">
    </form>

    <form action="0/upload" method="post"
          enctype="multipart/form-data"><input type="hidden" name="_csrf" value="ea27d555-9d05-49ce-a217-f9dab3358c89"/>
        <input type="file" name="file" required>
        <input type="submit" name="uploadFile" value="Datei Hochladen">
    </form>

    <form action="0/search" method="post"><input type="hidden" name="_csrf" value="ea27d555-9d05-49ce-a217-f9dab3358c89"/>
        <div id="names">
            <div id="names[0]">
