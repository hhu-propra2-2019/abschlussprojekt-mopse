...
<head>
  ...
  <link href="/css/styles.min.css" rel="stylesheet">
        ...
        <meta name="_csrf" content="21e893fa-b716-454e-bb9e-da2b8ceb0a42"/>
...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="/material1/dir/1/search"
              method="post"><input type="hidden" name="_csrf" value="21e893fa-b716-454e-bb9e-da2b8ceb0a42"/>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/" method="post" id="material1-modal-edit-folder-form"><input type="hidden" name="_csrf" value="21e893fa-b716-454e-bb9e-da2b8ceb0a42"/>
    ...
    <div class="modal fade" id="material1-modal-edit-file"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/" method="post" id="material1-modal-edit-file-form"><input type="hidden" name="_csrf" value="21e893fa-b716-454e-bb9e-da2b8ceb0a42"/>
                        <div class="form-group">
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="/material1/dir/1/create" method="post"><input type="hidden" name="_csrf" value="21e893fa-b716-454e-bb9e-da2b8ceb0a42"/>
        ...
        <form class="input-group" action="/material1/dir/1/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="21e893fa-b716-454e-bb9e-da2b8ceb0a42"/>
