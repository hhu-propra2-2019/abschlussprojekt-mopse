...
<head>
  ...
  <link href="/css/styles.min.css" rel="stylesheet">
        ...
        <meta name="_csrf" content="c7f18783-678d-4635-ac89-923390d3a6b3"/>
...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="/material1/dir/1/search"
              method="post"><input type="hidden" name="_csrf" value="c7f18783-678d-4635-ac89-923390d3a6b3"/>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/" method="post" id="material1-modal-edit-folder-form"><input type="hidden" name="_csrf" value="c7f18783-678d-4635-ac89-923390d3a6b3"/>
    ...
    <div class="modal fade" id="material1-modal-edit-file" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/" method="post" id="material1-modal-edit-file-form"><input type="hidden" name="_csrf" value="c7f18783-678d-4635-ac89-923390d3a6b3"/>
                        <div class="form-group">
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="/material1/dir/1/create" method="post"><input type="hidden" name="_csrf" value="c7f18783-678d-4635-ac89-923390d3a6b3"/>
        ...
        <form class="input-group" action="/material1/dir/1/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="c7f18783-678d-4635-ac89-923390d3a6b3"/>
