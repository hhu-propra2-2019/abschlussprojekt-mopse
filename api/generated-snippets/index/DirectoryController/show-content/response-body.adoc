...
<div class="main-wrapper"><main>
    ...
    <form action="/create" method="post"><input type="hidden" name="_csrf" value="05aacfcf-6dad-4ee7-8bb4-31a3dcf46523"/>
        <input type="text" name="folderName">
        <input type="submit" name="newFolder" value="Neuer Ordner">
    </form>
    <form action="/upload" method="post"><input type="hidden" name="_csrf" value="05aacfcf-6dad-4ee7-8bb4-31a3dcf46523"/>
        <input type="file" name="file">
        <input type="submit" name="uploadFile" value="Datei Hochladen">
    </form>
    <form action="/search" method="post"><input type="hidden" name="_csrf" value="05aacfcf-6dad-4ee7-8bb4-31a3dcf46523"/>
        <div id="fileNames">
            <div id="fileNames[0]">
