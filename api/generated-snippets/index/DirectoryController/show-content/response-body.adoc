...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="/material1/dir/0/search"
              method="post"><input type="hidden" name="_csrf" value="c353b299-3c47-4a00-a8cc-8c8cf242fd2b"/>
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="/material1/dir/0/create" method="post"><input type="hidden" name="_csrf" value="c353b299-3c47-4a00-a8cc-8c8cf242fd2b"/>
        ...
        <form class="input-group" action="/material1/dir/0/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="c353b299-3c47-4a00-a8cc-8c8cf242fd2b"/>
