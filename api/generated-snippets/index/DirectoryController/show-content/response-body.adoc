...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="/material1/dir/0/search"
              method="post"><input type="hidden" name="_csrf" value="f89909bc-b098-4d82-a887-bc03fe2ff679"/>
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="/material1/dir/0/create" method="post"><input type="hidden" name="_csrf" value="f89909bc-b098-4d82-a887-bc03fe2ff679"/>
        ...
        <form class="input-group" action="/material1/dir/0/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="f89909bc-b098-4d82-a887-bc03fe2ff679"/>
