...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="0/search"
              method="post"><input type="hidden" name="_csrf" value="e1cce906-27cf-4e14-98e2-22b4a4eed215"/>
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="0/create" method="post"><input type="hidden" name="_csrf" value="e1cce906-27cf-4e14-98e2-22b4a4eed215"/>
        ...
        <form class="input-group" action="0/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="e1cce906-27cf-4e14-98e2-22b4a4eed215"/>
