...
<head>
  ...
  <link href="/css/styles.min.css" rel="stylesheet">
        ...
        <meta name="_csrf" content="5d484080-25aa-461b-8f5c-7c52f929ca99"/>
...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="/material1/dir/1/search"
              method="post"><input type="hidden" name="_csrf" value="5d484080-25aa-461b-8f5c-7c52f929ca99"/>
        ...
        <div>
            <div class="material1-button-above-wrapper">
                <a class="btn btn-outline-primary" href="/material1/dir/0">
                    <span>
                        <img src="/img/arrow-90deg-up.svg" alt="">
                        Ebene hoch
                    </span>
                </a>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/" method="post" id="material1-modal-edit-folder-form"><input type="hidden" name="_csrf" value="5d484080-25aa-461b-8f5c-7c52f929ca99"/>
    ...
    <div class="modal fade" id="material1-modal-edit-file"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/" method="post" id="material1-modal-edit-file-form"><input type="hidden" name="_csrf" value="5d484080-25aa-461b-8f5c-7c52f929ca99"/>
                        <div class="form-group">
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="/material1/dir/1/create" method="post"><input type="hidden" name="_csrf" value="5d484080-25aa-461b-8f5c-7c52f929ca99"/>
        ...
        <form class="input-group" action="/material1/dir/1/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="5d484080-25aa-461b-8f5c-7c52f929ca99"/>
