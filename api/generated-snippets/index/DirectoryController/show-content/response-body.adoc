...
<div class="main-wrapper"><main>
    ...
    <div class="material1-search-wrapper">
        ...
        <form class="material1-search-form" id="material1-search-form" action="/material1/dir/0/search"
              method="post"><input type="hidden" name="_csrf" value="77cbc14c-3132-4ef3-b82f-c4d20a54ff41"/>
    ...
    <div class="material1-create-forms">
        ...
        <form class="input-group" action="/material1/dir/0/create" method="post"><input type="hidden" name="_csrf" value="77cbc14c-3132-4ef3-b82f-c4d20a54ff41"/>
        ...
        <form class="input-group" action="/material1/dir/0/upload" method="post"
              enctype="multipart/form-data"><input type="hidden" name="_csrf" value="77cbc14c-3132-4ef3-b82f-c4d20a54ff41"/>
