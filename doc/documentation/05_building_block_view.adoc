...
| ExceptionHandler | _Fängt sämtliche Exceptions, die im Projekt geworfen werden und stellt diese bereit._ | _Ein Administrator kann hier alle Exceptions einsehen._
|===
