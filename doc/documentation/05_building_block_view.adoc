...
| _Um die Informationen über die Unterordner einer Gruppe zu erhalten, wird eine Anfrage an den `DirectoryService` gestellt.
Ebenso kommunziert er über eine API mit `GruppenFindung`._
...
include::../api/generated-snippets/index/GroupController/get-all-files-of-directory/path-parameters.adoc[]
include::../api/generated-snippets/index/GroupController/get-group-url/path-parameters.adoc[]
