...
_Die Bausteinsicht ist eine hierarchische Sammlung von Blackboxen und Whiteboxen (siehe Abbildung unten) und deren Beschreibungen._
...
_*Ebene 1* ist die Whitebox-Beschreibung des Gesamtsystems, zusammen mit Blackbox-Beschreibungen der darin enthaltenen Bausteine (in unserem Fall die einzelnen Schichten)._
...
****
_Ebene 1 zeigt das Gesamtsystem bzw. dessen Komponenten (also die 5 Schichten), die Darstellung erfolgt genauso wie zuvor auch._
...
Begründung:: Von der HTML Presentation aus wird je nach Route ein bestimmter Controller in der Presentation Layer angesteuert.
...
include::../../build/generated-snippets/index/DirectoryController/show-content/path-parameters.adoc[]
include::../../build/generated-snippets//index/DirectoryController/create-folder/path-parameters.adoc[]
include::../../build/generated-snippets//index/DirectoryController/delete-directory/path-parameters.adoc[]
include::../../build/generated-snippets//index/DirectoryController/search-folder/path-parameters.adoc[]
include::../../build/generated-snippets//index/DirectoryController/upload-file/path-parameters.adoc[]

FileController::

Dieser hat folgende Routen:

include::../../build/generated-snippets/index/FileController/delete-file/path-parameters.adoc[]
include::../../build/generated-snippets/index/FileController/download-file/path-parameters.adoc[]

GroupController::

Dieser hat folgende Routen:

include::../../build/generated-snippets/index/GroupController/get-all-files-of-directory/path-parameters.adoc[]
include::../../build/generated-snippets/index/GroupController/get-group-url/path-parameters.adoc[]
include::../../build/generated-snippets/index/GroupController/search-file/path-parameters.adoc[]

GroupsController::

Dieser hat folgende Routen:

include::../../build/generated-snippets/index/GroupsController/get-all-groups/httpie-request.adoc[]
****
